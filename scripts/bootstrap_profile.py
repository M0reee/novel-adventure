...
FACTION_SUFFIXES = ("宗", "门", "派", "族", "家族", "学院", "帝国", "皇室", "公会", "联盟", "佣兵团", "殿", "阁", "谷", "塔", "公司", "集团", "教会", "军团", "基地")
LOCATION_SUFFIXES = ("城", "镇", "村", "山", "谷", "林", "域", "国", "院", "塔", "沙漠", "山脉", "洞府", "遗迹", "空间", "界", "星", "星球", "基地", "港", "区")
ITEM_SUFFIXES = ("丹", "药", "灵液", "卷轴", "令牌", "戒", "剑", "刀", "枪", "甲", "符", "法宝", "晶核", "魔核", "芯片", "药剂")
TECHNIQUE_SUFFIXES = ("诀", "功", "掌", "拳", "剑法", "刀法", "身法", "秘法", "术", "阵", "仪式", "斗技", "技能")

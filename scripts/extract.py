...
KEYWORDS: dict[str, list[str]] = {
    ...
    "story_arc": ["三年之约", "退婚", "复仇", "寻找", "追寻", "收服", "救援", "重建", "回归", "大会", "试炼", "战争"],
    "recurring_mission": ["长期", "多次", "反复", "继续", "目标", "任务", "委托", "追查", "寻药", "筹措", "历练", "调查"],
    "playable_hook": ["悬赏", "委托", "试炼", "拍卖", "残图", "线索", "追杀", "招收", "争夺", "寻药", "炼药"],
}

ITEM_PATTERNS = [
    r"([\u4e00-\u9fff]{2,12}(?:丹|散|灵液|药|火|异火|卷轴|纳戒|重尺|残图|令牌|药鼎|法宝|飞剑|符箓|圣剑|法杖|护符|神器|遗物|封印物|芯片|义体|模块|装甲|药剂|枪械|晶核|魔核))",
]
TECHNIQUE_PATTERNS = [
    r"([\u4e00-\u9fff]{2,12}(?:诀|功|掌|尺|指|身法|斗技|秘法|火莲|雷动|玄变|天怒|剑法|刀法|枪法|法术|魔法|仪式|技能|战术|协议|算法))",
]
